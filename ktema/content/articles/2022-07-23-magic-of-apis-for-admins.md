...
You can watch the video from the talk if you're interested in following along. There's a taste at the end of the power (and danger!) you can explore by using APIs and Python to script solutions to business problems. 

{{ vimeo(id="732817980/cc19af32dc") }}
